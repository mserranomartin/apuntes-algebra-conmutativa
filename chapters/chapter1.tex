...
Cuando $\mathfrak a_1 + \mathfrak a_2 = A$ se dice que los ideales son \emph{comaximales} o \emph{coprimos}. En particular, cualesquiera dos maximales son coprimos porque $\mathfrak{m}+\mathfrak{m'} \supsetneq \mathfrak{m}$ y por maximalidad eso implica que $\mathfrak{m}+\mathfrak{m'} = (1)$.
\end{remark}
