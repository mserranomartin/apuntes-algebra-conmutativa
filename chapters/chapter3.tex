...
\begin{itemize}
    \item [i)] Existe $\pi:M\longrightarrow M'$ homomorfismo de $A$-módulos tal que $\pi\circ f=º_{M'}$
...
\end{proposition}
Demostración. \textit{$1)\Rightarrow 2)$} Sea $m''\in M''$. Por ser $g$ sobreyectiva, existe $m\in M$ tal que $g(m)=m''$. Definimos $$\begin{array}{rcl}
    \sigma:M''&\longrightarrow&M\\
    m''&\longmapsto&m-(f\circ\pi)(m)
\end{array}$$
\end{document}
