...
\begin{proposition}
	Sea $M$ un $A$-módulo y sea $$N'\overset{f}{\longrightarrow}N\overset{g}{\longrightarrow}N''\longrightarrow 0$$ una sucesión exacta. Se cumple que $$M\otimes_A N'\overset{1_M\otimes f}{\longrightarrow}M\otimes_A N\overset{1_M\otimes g}{\longrightarrow}M\otimes_A N''\longrightarrow 0$$ es también una sucesión exacta.
\end{proposition}
