...
\begin{proof}
	...
	Comprobemos el segundo de los isomorfismos. En primer lugar, definamos
	$$\begin{array}{rcl}
...
\end{proposition}
\begin{proof}
	En primer lugar, ($1\Leftrightarrow 2$) es la propia definición de $A$-módulo plano. También son claras las implicaciones ($2\Rightarrow3$) y ($3\Rightarrow4$). Probemos ($3\Rightarrow2$) y ($4\Rightarrow3$).
